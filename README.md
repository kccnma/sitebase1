# [SiteBase (v1)](https://kccnma.github.io/sitebase1/ "SiteBase v1 Backup")

This is a backup repo for the initial (v1) development version of Sitebase, a minimal HTML + CSS + JS base front-end framework for simple web site projects. This is the full dev version that contains all uncompiled source files, documentation, lessons, and post-build pre-compiled static-rendered files in multiple variations for different users and development environments.
...
## Documentation
- [SiteBase v1 documentation](https://kccnma.github.io/sitebas1/documentation.html "SiteBase Docs (incomplete)")

## Demos

- [SiteBase v1 Website](https://kccnma.github.io/sitebase1/ "SiteBase Website")
- [SiteBase v1 Static Demo (No Frills)](https://kccnma.github.io/sitebase1/variations/sitebase1/ "SiteBase Static Demo (No Frills)")
...
## Updates
- 05-27-26 
  - moved v1 dev code from sitebase repo to sitebase1 repo
- 10-03-25
